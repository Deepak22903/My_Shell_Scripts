...
# Decrease volume on the default sink
...
elif [ "$CURRENT_PERCENT" -lt 1 ]; then # Use 1% threshold for off/muted appearance if desired
  ICON="audio-volume-off"               # Or muted, depending on theme
